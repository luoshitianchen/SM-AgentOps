# SM-AgentOps 多环境配置矩阵（MULTI-ENV MATRIX）
...
| 数据库名 | sm_agentops_dev | sm_agentops_staging | sm_agentops |
| 域名 | sm-agentops.dev.sm.example.com | sm-agentops.staging.sm.example.com | sm-agentops.sm.example.com |
